...
function ajaxDispatching(region_id) {
    ...
    var is_free_shipping = $("input[name='is_free_shipping']").val();
    var weight = $("input[name='weight']").val();
	if(typeof(goods_id) != 'undefined' && region_id!= ''){
		$.ajax({
			type: "POST",
			dataType: 'json',
			data: {goods_id: goods_id, region_id: region_id,is_free_shipping:is_free_shipping,weight:weight},
...
//                        addrHtml = oldAddrHtml + "," + tProvince + tCity + tArea + tTown;
			...
			function chooseProvince(provinceId) {
				...
				$('.store-selector .text>div').html(currentAreaInfo.currentProvinceName);
			...
			function chooseCity(cityId, cityName) {
				...
				$('.store-selector .text>div').html(currentAreaInfo.currentProvinceName + "," + cityName);
...
//                    $.getJSONP("https://d.jd.com/area/get?callback=getAreaListcallback&fid="+cityId);
			...
			function chooseArea(areaId, areaName) {
				...
				$('.store-selector .text>div').html(currentAreaInfo.currentProvinceName + "," + cityName + "," + areaName);
