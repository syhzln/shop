! function(e) {
	"use strict";
	var t = function(t, i) {
		this.$element = e(t), this.$indicators = this.$element.find(".carousel-indicators"), this.carousel_inner = this.$element.find(".carousel-inner"), this.options = i, "hover" == this.options.pause && this.carousel_inner.on("mouseenter", e.proxy(this.pause, this)).on("mouseleave", e.proxy(this.cycle, this))
	};
	t.prototype = {
		cycle: function(t) {
