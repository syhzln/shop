...
//        $shipping = M('Plugin')->where("code", $shipping_code)->cache(true,WALHAO_CACHE_TIME)->find();
        $data = array(
...
//        {
//            $goods = M('goods')->where("goods_id", $val['goods_id'])->cache(true,WALHAO_CACHE_TIME)->find();
