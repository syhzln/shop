...
function isMobile()
{
    //@todo 目前手机五花八门,通过协议,代理这些都不太好确定来访源,故通过UA相对来说效率更高一些
    // 判断手机发送的客户端标
    if (isset ($_SERVER['HTTP_USER_AGENT']))
    {
        $clientkeywords = array ('nokia','sony','mot','samsung','htc','sgh','sharp','lenovo','iphone','ipod','blackberry','meizu','android','symbian','ucweb','windowsce','palm','operamini','operamobi','openwave','nexusone','cldc','midp','wap','mobile');
