    ...
    public function imageUp()
    {
        ...
        if (true !== $result || !$file) {
            ...
            if ($ossConfig['oss_switch']) {
                //商品图片可选择存放在oss
                $object = 'public/upload/'.$savePath.md5(microtime(true).rand(9999,99999)).'.'.pathinfo($file->getInfo('name'), PATHINFO_EXTENSION);
