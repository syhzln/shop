...
// 签名证书路径
const SDK_SIGN_CERT_PATH = 'D:/wamp/www/walhao/walhao_b2/plugins/payment/unionpay/certs/700000000000001_acp.p12';

// 签名证书密码
const SDK_SIGN_CERT_PWD = '000000';

// 密码加密证书（这条一般用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = 'D:/wamp/www/walhao/walhao_b2/plugins/payment/unionpay/certs/acp_prod_enc.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = 'D:/wamp/www/walhao/walhao_b2/plugins/payment/unionpay/certs/';
...
//文件下载目录 
const SDK_FILE_DOWN_PATH = '/web2/walhao2.0/public/plugins/payment/unionpay/file/';

//日志 目录 
const SDK_LOG_FILE_PATH = '/web2/walhao2.0/public/plugins/payment/unionpay/logs/';
