...
function get_storeCategory(id,next,select_id){
    var url = '/index.php?m=Home&c=api&a=get_storeCategory&parent_id='+ id;
    $.ajax({
        type : "GET",
        url  : url,
        error: function(request) {
...
function get_storeCategoryThree(id,next,select_id){
    var url = '/index.php?m=Home&c=api&a=get_storeCategoryThree&parent_id='+ id;
    $.ajax({
        type : "GET",
        url  : url,
        error: function(request) {
