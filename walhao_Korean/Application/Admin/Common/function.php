...
function getAllMenu(){
	return	array(
			...
			'member' => array('name'=>'会员管理','icon'=>'fa-user','sub_menu'=>array(
                ...
                array('name'=>'修改用户密码','act'=>'changePassword','control'=>'User'),
                array('name'=>'会员工单','act'=>'user_message','control'=>'User'),
                array('name'=>'已完结工单','act'=>'finished_message','control'=>'User'),
			)),
...
//					array('name' => '代金券','act'=>'index', 'control'=>'Coupon'),
			...
			'content' => array('name' => '内容管理', 'icon'=>'fa-comments', 'sub_menu' => array(
					...
					array('name' => '发布规章', 'act'=>'guizhang_list', 'control'=>'Article'),
			)),
...
//					array('name' => '提现申请', 'act'=>'withdrawals', 'control'=>'Distribut'),
			...
			'finance' => array('name' => '财务统计', 'icon'=>'fa-book', 'sub_menu' => array(
                   ...
                   array('name' => '会员转账记录', 'act'=>'user_transfer', 'control'=>'Finance'),
			)),
...
//					array('name' => '推送查询', 'act'=>'profit', 'control'=>'Report'),
			))
	);
}
