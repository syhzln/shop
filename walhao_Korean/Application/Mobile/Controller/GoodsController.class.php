...
class GoodsController extends MobileBaseController {
    ...
    public function goodsList(){
    	...
    	if($count > 0)
    	{
    		$goods_list = M('goods')->where("special = 0 and goods_id in (".  implode(',', $filter_goods_id).")")->order("$sort $sort_asc")->limit($page->firstRow.','.$page->listRows)->select();
...
//        $show = $page->show();
    ...
    public function ajaxSpecialList(){
        ...
        $page = new AjaxPage($good_list_count,8);
