 ...
 */
/**
 * 更新商品编辑,有改动后商品下架,需再次审核
 * @Authorhtl {Ning<nk11@qq.com>}
 * @DateTime  2017-02-27T13:10:50+0800 
 */
            ...
            {                
                ...
                if(!$Goods->create(NULL,$type))// 根据表单提交的POST数据创建数据对象
                {
                    ...
                    if ($type == 2)
                    {
                        ...
                        if($goods['shop_price']!=$_POST['shop_price']||$goods['market_price']!=$_POST['market_price']||$goods['cost_price']!=$_POST['cost_price']) $Goods->goods_state = 0;//价格有变动,需重新审核
